   ...
   case '2':
    {          cout << "\t\t     THANK YOU FOR USING THIS SOFTWARE"<<endl;
        ...
        cout << "\n\n";
             ...
             cout << "\t   1. AYUSH PANDEY                 NIT/01182/11          +919744616880\n\n";
             cout << "\t   2. JAY PANDEY                   NIT/01446/11          +919264890691\n\n";
             cout << "\t   3. AISHWARYA PANDEY             NIT/01479/11          +919412577702\n\n";
             cout << "\t   4. RAJ PANDEY                   NIT/01480/11          +919462306023\n\n";
             cout << "\t   5. AKASH PANDEY                 NIT/01424/11          +919653114104\n\n";
              cout << "\n\n";
             cout<<"\t\t\t\t\t\t\t\t\t   SUBMITED TO:   CYPHERBYTE TECHNOLIGIES\n";
             cout<<"\t\t\t\t\t\t\t\t\t   SUBMITED DATE: 12/08/2023 ";
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tOPERATING SYSTEM MARK :"<<s.arc<<endl<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tOPERATING SYSTEM MARK :"<<s.arc<<endl;
